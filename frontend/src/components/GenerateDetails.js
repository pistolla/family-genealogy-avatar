...
function GenerateDetails({ name, description, textChange, active, nextStep }) {
    const proceed = e => {
		e.preventDefault();
		nextStep();
	};
        ...
        <div className={`form__card ${active ? 'active' : ''}`}>
				<div className="input__container">
					<label className="input__container--label" htmlFor="name">
						Patriach or Matriach Full name?
					</label>
					<input
				...
				<div className="input__container">
					<label className="input__container--label" htmlFor="description">
